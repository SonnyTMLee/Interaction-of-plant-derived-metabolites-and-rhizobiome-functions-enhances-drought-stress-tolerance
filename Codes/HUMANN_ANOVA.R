...
write.csv(anova_results, file = "HUMANN_ANOVA_Location.csv", row.names = FALSE)
...
write.csv(wilcox_results, file = "HUMANN_WILCOX_Location.csv", row.names = FALSE)

# Display results


wilcox_results <- read.csv("HUMANN_WILCOX_Location.csv", as.is = TRUE)
anova_results_Location <- read.csv("HUMANN_ANOVA_Location.csv", as.is = TRUE)
...
write.csv(anova_results, file = "HUMANN_ANOVA_Ecotype.csv", row.names = FALSE)
...
# Save Wilcoxon results to CSV
write.csv(wilcox_results, file = "HUMANN_WILCOX_Ecotype.csv", row.names = FALSE)
...
write.csv(anova_results, file = "HUMANN_ANOVA_Population.csv", row.names = FALSE)
...
write.csv(results_to_write, "HUMANN_WILCOX_Population.csv", row.names = FALSE)

# Print the written results
print(results_to_write)


anova_results_population <- read.csv("HUMANN_ANOVA_Population.csv", as.is = TRUE)
...
wilcox_results <- read.csv("HUMANN_WILCOX_Population.csv", as.is = TRUE)
...
# Write results to CSV
write.csv(results_to_write, "HUMANN_WILCOX_Loc_eco.csv", row.names = FALSE)

# Print the written results
print(results_to_write)


anova_results_Loc_eco <- read.csv("HUMANN_ANOVA_Loc_eco.csv", as.is = TRUE)
...
wilcox_results <- read.csv("HUMANN_WILCOX_Loc_eco.csv", as.is = TRUE)
anova_results_Ecotype <- read.csv("HUMANN_ANOVA_Loc_eco.csv", as.is = TRUE)
